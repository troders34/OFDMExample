...
resourceGrid(1:gridSpacing:numSubCar,HDR_IDX+1:end) = pilotMapIndex; % Load pilot signal map index
modDataInd = 1:numSubCar;
modDataInd(1:gridSpacing:numSubCar) = []; % remove the pilot indices from modData indices
